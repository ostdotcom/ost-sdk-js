...
const airdropData = {amount: 0.00001, airdropped: true, user_ids: helper.OST_KIT_TRANSFER_FROM_UUID + "," + helper.OST_KIT_TRANSFER_TO_UUID};

describe('services/v1/airdrops/execute', function () {
