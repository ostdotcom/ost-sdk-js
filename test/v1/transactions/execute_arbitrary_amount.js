...
const transactionData = {
  from_user_id: helper.OST_KIT_TRANSFER_FROM_UUID, to_user_id: helper.OST_KIT_TRANSFER_TO_UUID, action_id: '', amount: 0.01};
...
describe('services/v1/transactions/execute (NON ARBITRARY AMOUNT)', function () {
